<template>
  ...
  >
    <div class="side-nav" id="mySidebar">
      <div class="user">
        ...
        <img src="images/Hecta.png" class="star-img" />
      </div>
      <ul class="lists">
        <li>
...
<script>
import SignupForm from "@/components/RegisterUser.vue";
export default {
  components: {
    SignupForm,
  },
